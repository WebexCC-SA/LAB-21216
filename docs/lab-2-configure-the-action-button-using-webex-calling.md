...
2. It will bring up **Device Configuration** page. Scroll down on the page, go to **Phone** > **Action Button.** On the Action Button configuration page, populate the following values and click **Next**.
    ...
    2. **Action Button Service Destination** > **Cisco 98XX >**  Enter the DID number assigned **Anita Perez**.
    3. **Action Button Service Name > Cisco 98XX >** Enter any description (Like Anita Perez)
...
6. Click the **Action Button** (the red button on top of the device) on Cisco 9871, and observe that there is pop up in red “<**Service Name> Calling <The number you have configured> in 5 seconds**. **Screen will trun off, Press any key to turn it back on**”. That 5 seconds will count down to 1 and the call will be placed. Answer the call on other Cisco 98XX. Make sure the call gets connected.
7. Now, while the call is active, press any key on the phone (where the call is placed froom) and observe that you can get screen back on and all options (like mute, end call, etc.,) are available. You can also press volume button up (+ sign) and listen to remote party.

### **Module 2d: Configuring the Action button with Dial Out Delay**
...
### **Module 2e: Configuring the Action button Service Trigger**
...
### **Module 2f: Configuring the Action button for a *custom service***

You can customize action button for a specific needs to fit into your requirement. Like sending to an URL to display some office/evacutation/route/directory/custom message etc.,
...
2. It will bring up **Device Configuration** page. Scroll down on the page, go to **Phone** > **Action Button.** On the Action Button configuration page, populate the following values and click **Next**.
    ...
    2. **Action Button Service Destination** > **Cisco 98XX >**  use one of the URLs below.

**Option 1:** <https://www.tmedemo.com/quiz/www/evacuate.xml> (evacuation map)
...
9. **Action Button Service Destination** > **Cisco 98XX >**

tel:+1XXXXXXXXXX + https://www.tmedemo.com/quiz/www/evacuate.xml

(Replace XXXXXXXXXX with phone number assigned to other user in demo)

![A screenshot of a computer AI-generated content may be incorrect.](assets/docx-image-047.png)

NOTE: Make sure you follow he format of [**tel:+XXXXXXXXXX**](tel:+XXXXXXXXXX) **+ URL** when you create your own destination (including the country code).
...
12. Continuing on Workstation 1, on the browser tab where you have Webex CH logged in. Navigate to **MANAGEMENT > Devices.** It will list both the phones you registered above. Select one of the **Cisco 98XX** devices & clear out (set all parameters to **Factory**) all Ation Button parameters first.
13. Then select the device again & on the device Overview page go to **Configuration** > **All configurations.**
14. Drop down the option for **Service Trigger** and choose **MultiTrigger**.

![](assets/docx-image-049.png)

15. It will bring up **Device Configuration** page. Scroll down on the page, go to **Phone** > **Action Button > ServiceTriggerMultiTrigger > SinglePress.**

![A white background with black lines AI-generated content may be incorrect.](assets/docx-image-050.png)

16. On the **SinglePress** configuration page, update the following values.
17. **Action Button Function** > **Cisco 98XX** > drop down the option and set **Emergency Call**
18. **Action Button Service Destination** > **Cisco 98XX >**  Enter the DID number assigned **Anita Perez**.
19. **Action Button Service Name > Cisco 98XX >** Enter any description (Like Emergeny Call)

![A screenshot of a computer AI-generated content may be incorrect.](assets/docx-image-051.png)

20. Scroll up on the page and select **ActionButton** (hyperlink) to configure the rest of the triggers.
21. It will bring up **Device Configuration** page. Scroll down on the page, go to **Phone** > **Action Button > ServiceTriggerMultiTrigger > PressThreeTimes.**

![A screenshot of a phone AI-generated content may be incorrect.](assets/docx-image-052.png)

22. On the **PressThreeTimes** configuration page, update the following values and click **Next**.
23. **Action Button Function** > **Cisco 98XX** > drop down the option and set **Custom**
24. **Action Button Service Destination** > **Cisco 98XX >**  Enter below URL <https://www.tmedemo.com/quiz/www/menu.xml>
25. **Action Button Service Name > Cisco 98XX >** Enter any description (Like Corporate Directory)

![A screenshot of a computer AI-generated content may be incorrect.](assets/docx-image-053.png)

26. Scroll up on the page and select **ActionButton** (hyperlink) to configure the rest of the triggers.
27. It will bring up **Device Configuration** page. Scroll down on the page, go to **Phone** > **Action Button > ServiceTriggerMultiTrigger > LongPress.**
28. On the **PressThreeTimes** configuration page, update the following values and click **Next**.
29. **Action Button Function** > **Cisco 98XX** > drop down the option and set **Custom**
30. **Action Button Service Destination** > **Cisco 98XX >**  Enter below URL <https://www.tmedemo.com/quiz/www/evacuate.xml>
31. **Action Button Service Name > Cisco 98XX >** Enter any description (Like Evacuation Map)

![A screenshot of a computer AI-generated content may be incorrect.](assets/docx-image-054.png)

32. On the next page, it will list the changes that we are going make to the device. Click **Apply.** Click **Close**, on the next page. It will take you to Device phone on Control Hub.
33. Now go to the phone and press
34. **Single Press** > It should place call to the number you configured. Make sure call gets connected, then hangup the call after few seconds.
35. **Press Three Times** > It should display the Corporate Directory you configured.
36. **Long Press** > It should display the Evacuation Map.
