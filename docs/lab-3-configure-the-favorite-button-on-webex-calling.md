...
1. In the browser tab where you are logged in to Collaboration Control Hub, navigate to **MANAGEMENT > Devices.** It will list the phone you registered above. Select your **Cisco 98XX** device. On the device Overview page, go to **Configuration** > **All configurations.**
